 ...
 * Time: 10:16 PM
 */
public class FormatNodeCapability {
    private static Logger LOGGER = Logger.getLogger(FormatNodeCapability.class);
...
//            capabilities.add(NodeReadingControllerImpl.getInstance().listNodeReadings(node, roomCapability, 1).get(0));
            ...
            String output = null;
            output = (String) RdfFormatter.getInstance().formatNodeReading(capabilities.get(0));
